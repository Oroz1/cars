...
SECRET_KEY = 'django-insecure-eq7!u!41ciu!&pu2@hjgu$v^qv$v2&15@yc8&&q_xr2jtg087d'
...
JAZZMIN_SETTINGS = {
    ...
    "icons": {
        ...
        'core.Currencies': 'fab fa-gg-circle',
        'core.Images': 'fas fa-images',
        'core.Brands': 'fas fa-copyright',
        'core.Models': 'fas fa-tags',
        'core.TypeOfCars': 'fas fa-quote-right',
        'core.Gearboxes': 'fas fa-wrench',
        'core.FuelTypes': 'fas fa-gas-pump',
        'core.Cars': 'fas fa-car',
